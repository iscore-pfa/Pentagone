    ...
    , m_dispatcher{doc.commandStack}
{
  ...
  setObjectName("PolygonInspectorWidget");
  setParent(parent);
    ...
    const Device::FullAddressAccessorSettings& newAddr)
{
  ...
  auto cmd = new ChangePolygonAddress{process(), newAddr.address};
    ...
    , m_dispatcher{doc.commandStack}
{
  ...
  setObjectName("PentagoneInspectorWidget");
  setParent(parent);
    ...
    const Device::FullAddressAccessorSettings& newAddr)
{
  ...
  auto cmd = new ChangePentagoneAddress{process(), newAddr.address};
    ...
    , m_dispatcher{doc.commandStack}
{
  ...
  setObjectName("HexagonInspectorWidget");
  setParent(parent);
    ...
    const Device::FullAddressAccessorSettings& newAddr)
{
  ...
  auto cmd = new ChangeHexagonAddress{process(), newAddr.address};
    ...
    , m_dispatcher{doc.commandStack}
{
  ...
  setObjectName("CircleInspectorWidget");
  setParent(parent);
    ...
    const Device::FullAddressAccessorSettings& newAddr)
{
  ...
  auto cmd = new ChangeCircleAddress{process(), newAddr.address};
    ...
    , m_dispatcher{doc.commandStack}
{
  ...
  setObjectName("InfiniteInspectorWidget");
  setParent(parent);
    ...
    const Device::FullAddressAccessorSettings& newAddr)
{
  ...
  auto cmd = new ChangeInfiniteAddress{process(), newAddr.address};
    ...
    , m_dispatcher{doc.commandStack}
{
  ...
  setObjectName("HeartInspectorWidget");
  setParent(parent);
    ...
    const Device::FullAddressAccessorSettings& newAddr)
{
  ...
  auto cmd = new ChangeHeartAddress{process(), newAddr.address};
