...
Component::Component(
    ::Circle::ProcessModel& element,
    const ::Execution::Context& ctx,
    const Id<score::Component>& id,
    QObject* parent)
    : ::Execution::
          ProcessComponent_T<Circle::ProcessModel, ossia::node_process>{
              element,
              ctx,
              id,
              "Executor::CircleComponent",
              parent}
{
  ...
  con(element, &Circle::ProcessModel::splineChanged, this, [this] {
    this->recompute();
  });
