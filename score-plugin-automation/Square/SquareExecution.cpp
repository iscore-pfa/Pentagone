...
Component::Component(
    ::Square::ProcessModel& element,
    const ::Execution::Context& ctx,
    const Id<score::Component>& id,
    QObject* parent)
    : ::Execution::
          ProcessComponent_T<Square::ProcessModel, ossia::node_process>{
              element,
              ctx,
              id,
              "Executor::SquareComponent",
              parent}
{
  ...
  con(element, &Square::ProcessModel::splineChanged, this, [this] {
    this->recompute();
  });
