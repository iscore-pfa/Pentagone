...
W_OBJECT_IMPL(Triangle::ViewTriangle)
namespace Triangle{

ViewTriangle::ViewTriangle(QGraphicsItem* parent) : LayerView{parent}
{
...
void ViewTriangle::paint_impl(QPainter* p) const
{
...
void ViewTriangle::updateSpline()
{
...
void ViewTriangle::mousePressEvent(QGraphicsSceneMouseEvent* e)
{
  auto btn = e->button();
...
void ViewTriangle::mouseMoveEvent(QGraphicsSceneMouseEvent* e)
{
...
void ViewTriangle::mouseReleaseEvent(QGraphicsSceneMouseEvent* e)
{
  if (m_clicked)
  {
    changed();
...
*/
optional<std::size_t> ViewTriangle::findControlPoint(QPointF point)
{
  int pointIndex = -1;
  qreal distance = -1;
