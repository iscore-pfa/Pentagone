...
Component::Component(
    ::Polygon::ProcessModel& element,
    const ::Execution::Context& ctx,
    const Id<score::Component>& id,
    QObject* parent)
    : ::Execution::
          ProcessComponent_T<Polygon::ProcessModel, ossia::node_process>{
              element,
              ctx,
              id,
              "Executor::PolygonComponent",
              parent}
{
  ...
  con(element, &Polygon::ProcessModel::splineChanged, this, [this] {
    this->recompute();
  });
