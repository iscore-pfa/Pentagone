...
namespace Polygon
{
class ChangePolygon : public score::Command
{
  SCORE_COMMAND_DECL(
...
public:
  ...
  {
    m_path.find(ctx).setPolygon(m_old);
  }
  void redo(const score::DocumentContext& ctx) const override
  {
    m_path.find(ctx).setPolygon(m_new);
  }
...
public:
  ...
  const Polygon::ProcessModel& model() const override;
